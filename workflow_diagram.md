...
graph TD
    ...
    subgraph "Multi-Agent System"
        ...
        subgraph "Worker Agents & Tools"
            ...
            InventoryTools[- check_stock_levels <br/> - check_reorder_status <br/> - place_stock_order]
            QuotingTools[- search_quote_history <br/> - get_pricing_and_availability]
            OrderingTools[- finalize_order]
        end
    end
